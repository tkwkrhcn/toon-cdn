(function () {
  ...
  const banners = [
    ...
    { url: "http://jp-7777.com/@5rrPo", img: "https://imagedelivery.net/hn8cyNBhDj7fHt_rfVXsFQ/7c55f7ee-b6e8-4ec5-9c63-cbdec3653e00/public" },
  ...
  if (bannerContainer) {
    finalBanners.forEach(banner => {
      ...
      img.loading = "lazy";
      try {
        const domain = new URL(banner.url).hostname;
        img.alt = domain;
      } catch {
        img.alt = "무료웹툰";
      }
